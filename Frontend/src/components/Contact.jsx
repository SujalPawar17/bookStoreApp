    ...
    <div className="isolate bg-white dark:bg-gray-900 dark:text-gray-200 px-6 py-24 sm:py-32 lg:px-8">
      ...
      {submitted ? (
        <div className="mx-auto mt-16 max-w-xl sm:mt-20 text-center">
          <h3 className="text-2xl font-bold text-green-600">Thank you for your submission!</h3>
          <p className="mt-2 text-lg leading-8 text-gray-600 dark:text-gray-300">We will get back to you soon.</p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              ...
              <div className="mt-2.5">
                <input
                  ...
                  className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 dark:text-gray-900 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            <div>
              ...
              <div className="relative mt-2.5">
                <div className="absolute inset-y-0 left-0 flex items-center">
                  ...
                  <select
                    id="country"
                    name="country"
                    className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 dark:bg-gray-800 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
                  >
                    <option>IN</option>
                    <option>US</option>
                    <option>EU</option>
                ...
                <input
                  ...
                  type="tel"
                  autoComplete="tel"
                  className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 dark:text-gray-900 dark:bg-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
            ...
            <div className="flex gap-x-4 sm:col-span-2">
              ...
              <label htmlFor="agreed" className="text-sm leading-6 text-gray-600 dark:text-gray-400">
