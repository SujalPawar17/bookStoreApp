...
function Banner() {
  return (
    ...
    <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        ...
        <p className="text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus, fuga. Cum, eveniet recusandae quidem ad non, saepe odio, animi quam dolorem minima pariatur consequatur eos! Consectetur beatae consequuntur numquam mollitia!</p>
